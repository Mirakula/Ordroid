...
public class AdapterPoslateNarudzbe extends ArrayAdapter<Narudzba>{
	private Context context = null;
	private int selektovanaStavka;	
	private ArrayList<Narudzba> narudzbe=null;

	public AdapterPoslateNarudzbe(Context context, int textViewResourceId, ArrayList<Narudzba> narudzbe) {
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.poslatered, null);
		}		
		final DecimalFormat df=new DecimalFormat("0.000");
		//uzimamo stavku i ispisujemo njene atribute u odgovarajuca polja
		final Narudzba narudzba = getItem(position);			
		TextView tvNazivFirme=(TextView) v.findViewById(R.id.tvNazivFirme77);
		TextView tvNazivMisa=(TextView) v.findViewById(R.id.tvNazivMisa77);
		TextView tvVrijeme =(TextView) v.findViewById(R.id.tvVrijeme77);
		TextView tvIznos =(TextView) v.findViewById(R.id.tvIznosNarudzbe77);
		TextView tvTip=(TextView) v.findViewById(R.id.tvTipNarudzbe77);
		...
		v.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dialogStavke.getWindow().setAttributes(
       		    ...
       		    dialogStavke.setTitle("Pregled narudzbe");
       			...
       			Log.d("TAG", "Da li je maloprodaja: " + narudzba.dajTipDokumenta());
